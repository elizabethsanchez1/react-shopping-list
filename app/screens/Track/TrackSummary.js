...
import { getTrackableExerciseSets, getTrackedExercises } from "../../selectors/track";
          ...
          renderItem={({item, index}) => (
            <Card>
              ...
              <View style={{ flexDirection: 'row', paddingLeft:10, paddingRight: 10 }}>
                ...
                <StyledText style={{paddingLeft: 10}}>{trackedExercises[index].totalReps} reps</StyledText>
                <StyledText style={{paddingLeft: 10}}>{trackedExercises[index].totalVolume} lbs</StyledText>
              </View>
            </Card>
          )}
